...
static char font[]   = "Terminus (TTF):pixelsize=14";
...
static unsigned int keyrepeatdelay    = 200;
static unsigned int keyrepeatinterval = 50;
...
static const char* colorname[] = {
    /* 8 normal colors */
    "#000000", "#a40000", "#00ff00", "#c4a000", "#204a87", "#ce5c00", "#038e82",
    "#eaede6",

    /* 8 bright colors */
    "#555753", "#cc0000", "#55ff55", "#edd400", "#3465a4", "#f57900", "#05d2c1",
    "#ffffff",
...
static Key key[] = {
    ...
    {XKB_KEY_Up,           MOD_MASK_SHIFT | MOD_MASK_CTRL | MOD_MASK_ALT, "\033[1;8A",  0,
     0,                                                                                         0 },
    ...
    {XKB_KEY_Down,         MOD_MASK_SHIFT | MOD_MASK_CTRL | MOD_MASK_ALT, "\033[1;8B",
     0,                                                                                     0,  0 },
    ...
    {XKB_KEY_Left,         MOD_MASK_SHIFT | MOD_MASK_CTRL | MOD_MASK_ALT, "\033[1;8D",
     0,                                                                                     0,  0 },
    ...
    {XKB_KEY_Right,        MOD_MASK_SHIFT | MOD_MASK_CTRL | MOD_MASK_ALT, "\033[1;8C",
     0,                                                                                     0,  0 },
